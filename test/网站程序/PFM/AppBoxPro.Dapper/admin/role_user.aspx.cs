    ...
    public partial class role_user : PageBase
    {
        ...
        private void BindGrid2()
        {
            ...
            else
            {
                ...
                // 过滤选中角色下的所有用户
                builder.AddWhere("roleusers.RoleID = @RoleID");
                builder.AddParameter("RoleID", roleID);

                builder.FromSql = "users inner join roleusers on users.ID = roleusers.UserID";
        ...
        protected void btnDeleteSelected_Click(object sender, EventArgs e)
        {
            ...
            DB.Execute("delete from roleusers where RoleID = " +roleID+ " and UserID in (" + IDs + ")");
        ...
        protected void Grid2_RowCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Delete")
            {
                ...
                // 执行数据库操作
                DB.Execute("delete from roleusers where RoleID = @RoleID and UserID = @UserID", new { RoleID = roleID, UserID = userID });
