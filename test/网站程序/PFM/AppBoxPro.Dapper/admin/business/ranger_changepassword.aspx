<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ranger_changepassword.aspx.cs"
    Inherits="AppBoxPro.Dapper.admin.business.ranger_changepassword" %>
        ...
        <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false"  AutoScroll="true" runat="server">
            ...
            <Items>
                <f:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
                    ...
                    <Items>
                        <f:Label ID="labName" Label="姓名" runat="server">
                        </f:Label>
                        <f:Label ID="labTown" Label="乡镇名" runat="server">
                        </f:Label>
                        <f:Label ID="labVillage" Label="村名" runat="server">
                        </f:Label>
