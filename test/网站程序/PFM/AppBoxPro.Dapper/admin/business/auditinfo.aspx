<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="auditinfo.aspx.cs" Inherits="AppBoxPro.Dapper.admin.business.auditinfo" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    DataKeyNames="ID,Name" AllowSorting="true" OnSort="Grid1_Sort" SortField="Uploadtime"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Degree" SortField="Degree" Width="120px" HeaderText="巡护完成度" />
                        <f:BoundField DataField="Length" SortField="Length" Width="120px" HeaderText="巡护总长度" />
                        <f:BoundField DataField="Uploadtime" SortField="Time" Width="140px" HeaderText="记录时间" DataFormatString="{0:yyyy-MM-dd HH:mm}"/>
                        <f:WindowField TextAlign="Center" Icon="Information" ToolTip="查看详细信息" Title="查看详细信息"
                            WindowID="Window1" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/admin/business/auditinfo_view.aspx?id={0}"
                            Width="50px" />
                    </Columns>
                </f:Grid>
            </Items>
